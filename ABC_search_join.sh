...
#cut -f 9 ./ABC_search/$bname/total_ABC_HMM.table | sed 's/\s+//g' \
#| /data2/shane/Applications/custom/unigene_fa_sub.sh $i - > ./ABC_search/$bname/total_ABC_pre_blast.faa
...
$H/ABC_ID_SCRIPTS/general_scripts/fasta_rename.py ./proteomes/$bname'_unigene.faa' ./ABC_search/$bname/total_ABC_dict.csv > ./ABC_search/$bname/total_ABC_marked_proteome.faa
