...
do
  ...
  ## run cafe
  /data2/shane/Applications/CAFE/release/cafe ./CAFE/scripts/$b'_ABC_Cafe_Script.cafe'
  python2  $H/ABC_ID_SCRIPTS/Fulton_python_scripts/cafetutorial_report_analysis.py -i ./CAFE/outputs/$b'_ABC_cafe_output.cafe' -o ./CAFE/outputs/$b'_ABC_summary.txt'
